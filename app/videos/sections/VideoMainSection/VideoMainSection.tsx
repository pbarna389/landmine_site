...
export const VideoMainSection = ({ children }: VideoMainSectionProps) => {
	return (
		...
		>
			<div className="w-full h-full space-y-10 p-32 pl-2.5 pr-2.5 sm:pl-15 sm:pr-15 md:pl-20 md:pr-20 bg-linear-to-b from-transparent to-white flex flex-col gap-10 items-center justify-center">
				{children}
			</div>
		</section>
	)
