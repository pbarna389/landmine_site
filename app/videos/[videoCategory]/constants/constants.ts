export const VIDEO_CATEGORY_CONTENT = {
	vlog: {
		title: {
			text: 'gitáros videók',
			subText:
		...
		content: [
			{
				...
				link: ['https://www.youtube.com/playlist?list=PLn5cNXlh5JYNmWSHVLMsA6F_3wNRhaofk']
			},
			{
				id: 'sologuitar',
				title: 'technikák',
				...
				link: ['https://www.youtube.com/playlist?list=PLn5cNXlh5JYNJwmXN08v2fKEoC7dwTKWv']
			},
			{
				id: 'oneMinutes',
				...
				link: ['https://www.youtube.com/playlist?list=PLn5cNXlh5JYPHRBJL_zEBp0TZ7bktfo6Y']
			},
			{
				id: 'creativeRiffs',
				...
				text: [
					...
					'Szuper hazai, külföldi és saját témákból...'
				],
				link: [
					'https://www.youtube.com/playlist?list=PLn5cNXlh5JYOkBpxQwINbPpTYBdFwn_xD',
					'https://www.youtube.com/playlist?list=PLn5cNXlh5JYP7tqC2WmM6yB86XyK1Crwb',
					'https://www.youtube.com/playlist?list=PLn5cNXlh5JYMDfijriMMmsFTR2MQPFTp0'
				]
			}
		]
	},
		...
		content: [
			{
				...
				link: ['https://www.youtube.com/playlist?list=PLn5cNXlh5JYOK0qIXqaZz0LsQ0zHpK30U']
			},
			{
				id: 'improvisation',
				title: 'zeneírás és improvizálás',
				text: [
					'Improvizációs tippek és témák nem csak gitárosoknak.',
					'Zeneírós kulisszatitkok, inspiráció, hangszerelés, otthoni felvételkészítés.',
					'Zenei háttérmunkák az alapötlettől a végkifejletig.'
				],
				link: [
					'https://www.youtube.com/playlist?list=PLn5cNXlh5JYP_qrnVQGcRtylKSUVF5AOU',
					'https://www.youtube.com/playlist?list=PLn5cNXlh5JYMEgspuw_Ns5tqzHOF0zCro'
				]
			}
		]
	}
