...
export default async function VideoCategoryLayout({
	...
	return (
		<section className="flex flex-col items-center justify-center p-16 sm:p-24 md:p-32 pl-2.5 pr-2.5 sm:pl-15 sm:pr-15 md:pl-20 md:pr-20 border-t-5 border-white text-white bg-video-advert w-full *:text-white *:text-center *:font-montserrat">
			...
			<div className="flex flex-wrap p-0 pt-5 sm:p-5 items-center justify-center gap-5">
				{content.map((link) => (
